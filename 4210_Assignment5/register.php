				...
				<div class="col-xxl-4 col-xl-5 col-lg-5 col-md-7 col-sm-9">
					...
					<div class="card shadow-lg">
						<div class="card-body p-5">
							...
							<form id="login" method="POST" action="Admin_Panel/admin-process.php?action=login" enctype="multipart/form-data">
								<div class="mb-3">
								...
								<div class="mb-3">
										...
										<label class="text-muted" for="password">Old Password</label>
