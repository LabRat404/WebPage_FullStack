        ...
        <div class="container px-5 px-lg-5">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            ...
                            <?php
                              foreach($res as $cat_ele){
                                ...
                                foreach($prods as $prod_element){
                                    ...
                                    if($big_catid == $catid){
                                        echo' <a href="product.php?catid='.$catid.'&pid='.$pid.'">'.$name.'</a>';
                                    }
                                }
                                echo'
                                </div>
                ...
                <form class="form-inline my-2 my-lg-0 pr-3">
                    <text class="my-2 my-sm-0">Hi, <?php echo $user; ?></text>
                </form>
                    ...
                    <a id="cart-popover" class="btn btn-outline-dark" data-placement="bottom" title="Shopping Cart"
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbar-cart">
                                ...
                                <form action="payments.php" method="post" id="form1">
                                    ...
                                    <input type="hidden" name="business" value="sb-3gm7i15627234@business.example.com" />
                                ...
                                <button class="btn btn-success" type="submit" id="checkout" form="form1" >
                                    <i class="bi bi-basket2"></i> Check Out 
                                </button>
...
if($admin == true){
    echo'
    <a href="admin.php" class="btn btn-success mr-4">
    <span class="bi bi-terminal"> admin panel</span> 
    </a>
   ';
    echo'
    <form class="form-inline my-2 my-lg-0 pr-3" id="history" method="POST" enctype="multipart/form-data">
    <a class="btn btn-success bi bi-clipboard-check" type="submit" value="Submit" href="admin_order.php" > Purchase History</a>
    </form>
    ...
    echo'
    <form class="form-inline my-2 my-lg-0 pr-3" id="history">
    <a class="btn btn-success bi bi-clipboard-check" href="user_order.php" > User Purchase History</a>
    </form>
    ...
    echo'
    <a href="login.php" class="btn btn-success" id="check_out_cart">
    <span class="bi bi-key">  Login</span> 
    </a>';
}
